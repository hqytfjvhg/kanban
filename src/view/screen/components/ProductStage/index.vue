  ...
  <div class="ProductStage">
    ...
    >
      ...
      >
        ...
        <!-- <el-table-column align="center" label="Bates" prop="bates" :formatter="formatTime" /> -->
        <el-table-column
          align="center"
          label="PP"
          prop="pp"
        ...
        <el-table-column
          ...
          :formatter="formatTime"
        />
        <!-- <el-table-column align="center" label="PR" prop="pr" :formatter="formatTime" /> -->
        <el-table-column
          align="center"
          label="Launch"
          prop="launch"
  ...
  methods: {
    ...
    cellStyle({ rowIndex, columnIndex }) {
      ...
      if (rowIndex % 2 == 0 && columnIndex == 0) {
        return 'background: #15184d; border: none; border-right: 1px solid #252963; padding: 0;font-weight: 600; height: ' + this.ticketTableCellHeight + 'px'
      } else if (rowIndex % 2 == 0 && columnIndex == 2) {
        return 'font-size: 0.9rem; background: #15184d; border: none; border-right: 1px solid #dddddd88; padding: 0;font-weight: 600; height: ' + this.ticketTableCellHeight + 'px'
      } else if (rowIndex % 2 == 0 && columnIndex == 4) {
        return 'font-size: 0.9rem; background: #15184d; border: none; padding: 0;font-weight: 600; height: ' + this.ticketTableCellHeight + 'px'
      } else if (rowIndex % 2 == 0) {
        return 'font-size: 0.9rem; background: #15184d; border: none; border-right: 1px solid #252963; padding: 0; font-weight: 600;height: ' + this.ticketTableCellHeight + 'px'
      } else if (rowIndex % 2 == 1 && columnIndex == 0) {
        return 'background: #252963; border: none; border-right: 1px solid #171717; padding: 0;font-weight: 600; height: ' + this.ticketTableCellHeight + 'px'
      } else if (rowIndex % 2 == 1 && columnIndex == 2) {
        return 'font-size: 0.9rem; background: #252963; border: none; border-right: 1px solid #171717; padding: 0; font-weight: 600;height: ' + this.ticketTableCellHeight + 'px'
      } else if (rowIndex % 2 == 1 && columnIndex == 4) {
        return 'font-size: 0.9rem; background: #252963; border: none; padding: 0;font-weight: 600; height: ' + this.ticketTableCellHeight + 'px'
      } else {
        return 'font-size: 0.9rem; background: #252963; border: none; border-right: 1px solid #15184d; padding: 0;font-weight: 600; height: ' + this.ticketTableCellHeight + 'px'
      }
    },
    ...
    formatTime(row, column) {
      ...
      console.log(column)
      if (column.label === "Bates") {
        if (row.bates === null) return '/'
        const t1 = new Date(row.bates)
      ...
      if (column.label === "PP") {
        if (row.pp === null) return '/'
        const t1 = new Date(row.pp)
        const date1 = t1.getDate().toString()
        const month1 = t1.getMonth()
        const year1 = t1.getFullYear() - 2000
        return date1 + '-' + months[month1] + '-' + year1
      ...
      if (column.label === "MP") {
        ...
        const t1 = new Date(row.mp)
        const date1 = t1.getDate().toString()
        const month1 = t1.getMonth()
        const year1 = t1.getFullYear() - 2000
        return date1 + '-' + months[month1] + '-' + year1
      }
      if (column.label === "Despatch") {
        if (row.despatch === null) return '/'
        const t1 = new Date(row.despatch)
        const date1 = t1.getDate().toString()
        const month1 = t1.getMonth()
        const year1 = t1.getFullYear() - 2000
        return date1 + '-' + months[month1] + '-' + year1
      ...
      if (column.label === "PR") {
        ...
        const t1 = new Date(row.pr)
        const date1 = t1.getDate().toString()
        const month1 = t1.getMonth()
        const year1 = t1.getFullYear() - 2000
        return date1 + '-' + months[month1] + '-' + year1
      }
      if (column.label === "Launch") {
        if (row.launch === null) return '/'
        const t1 = new Date(row.launch)
        const date1 = t1.getDate().toString()
        const month1 = t1.getMonth()
        const year1 = t1.getFullYear() - 2000
        return date1 + '-' + months[month1] + '-' + year1
