...
<template>
  <div class="keyNew">
    <div class="key-news">
      <div class="news-box">
        <div class="news-tip">{{$t(`int.unInfo`)}}</div>
        <autoscroll :height="height" :speed="30">
          <div v-if="keyNews.length === 0" style="padding:5rem;font-size: 3rem;">
            <!-- None Int. News -->
            {{$t(`int.noneInfo`)}}
          </div>
          <div v-for="item in keyNews" :key="item.keynewId" class="news-content">
