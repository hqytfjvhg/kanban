...
<template>
    <div class="AvgTicket">
        <div class="new-create">
            ...
            <el-upload :action="base_api + '/info_screen/avgTicket/excel/handler'" multiple :limit="1"
        ...
        <el-dialog :title="title" :visible="visible" @close="visible = false">
            <AvgTicketTable :data="excelData"></AvgTicketTable>
        </el-dialog>
    </div>
</template>
...
import AvgTicketTable from './AvgTicketTable.vue';
export default {
    // import引入的组件需要注入到对象中才能使用
    components: {AvgTicketTable},
    name: 'AvgTicket',
    //props: {
    //  handA: {
    //    type: String,
