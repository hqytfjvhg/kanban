                                ...
                                <div class="ticket-box">
                                        ...
                                        <div class="ticket-content">
                                                <div class="ticket-item">
                                                        <img src="https://linyi-oss.oss-cn-shenzhen.aliyuncs.com/1.jpg" alt="" @click="changeOne(1)">
                                                        <el-checkbox v-model="checkeds[0].checked" :disabled="checkeds[0].disabled" @change="handleCheckAllChange(1)" >时尚芭莎夜</el-checkbox>  
                                                </div>
                                                <div class="ticket-item">
                                                        <img src="https://linyi-oss.oss-cn-shenzhen.aliyuncs.com/2.jpg" alt="" @click="changeOne(2)">
                                                        <el-checkbox v-model="checkeds[1].checked" :disabled="checkeds[1].disabled" @change="handleCheckAllChange(2)">春茗·凯韵</el-checkbox>
                                                </div>
                                                
                                        </div>
                                        <div class="ticket-content">
                                                <div class="ticket-item">
                                                        <img src="https://linyi-oss.oss-cn-shenzhen.aliyuncs.com/3.jpg" alt="" @click="changeOne(3)">
                                                        <el-checkbox v-model="checkeds[2].checked" :disabled="checkeds[2].disabled" @change="handleCheckAllChange(3)">十年</el-checkbox>
                                                </div>
                                                <div class="ticket-item">
                                                        <img src="https://linyi-oss.oss-cn-shenzhen.aliyuncs.com/4.jpg" alt="" @click="changeOne(4)">
                                                        <el-checkbox v-model="checkeds[3].checked" :disabled="checkeds[3].disabled" @change="handleCheckAllChange(4)">白蛇传</el-checkbox>
                                                </div>
                                        </div>
                                        <div class="ticket-content">
                                                <div class="ticket-item">
...
<script>
        import {toTicket, getStoId} from '@/api/ticket'
export default {
        name: 'TicketIndex',
                data() {
                        return {
